# usage:
# R --slave --vanilla --file=DEASMAACCRRanksCLI_XMCDAv3.R --args "[inDirectory]" "[outDirectory]"
...
source("ImpreciseRankSMAA.R")
results <- handleException(
  function() return(
    calculateRankSMAAForAll(inputs, inputs$samplesNo)
  ),
  xmcdaMessages,
