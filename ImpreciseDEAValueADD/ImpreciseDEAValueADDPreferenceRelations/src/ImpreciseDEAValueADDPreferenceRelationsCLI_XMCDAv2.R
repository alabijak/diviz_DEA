...
#script.wd <- "D:/Studia/doktorat/DEA-diviz/ImpreciseDEAValueADD/ImpreciseDEAValueADDPreferenceRelations/src/"
#setwd(script.wd)
...
#inDirectory <- "D:/Studia/doktorat/DEA-diviz/ImpreciseDEAValueADD/ImpreciseDEAValueADDPreferenceRelations/tests/in1.v2"
#outDirectory <- "D:/Studia/doktorat/DEA-diviz/ImpreciseDEAValueADD/ImpreciseDEAValueADDPreferenceRelations/tests/out1.v2"
# filenames
...
results <- handleException(
  function() return(
    calculateEfficiencyDominanceForAll(inputs)
    )
  ,
  xmcdaMessages,
