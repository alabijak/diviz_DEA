# usage:
# R --slave --vanilla --file=ImpreciseDEAValueADDEfficiencyCLI_XMCDAv2.R --args "[inDirectory]" "[outDirectory]"
...
#script.wd <- "D:\\Studia\\doktorat\\DEA-diviz\\ImpreciseDEAValueADD\\ImpreciseDEAValueADDEfficiency\\src"
#setwd(script.wd)
...
#inDirectory <- "D:\\Studia\\doktorat\\DEA-diviz\\ImpreciseDEAValueADD\\ImpreciseDEAValueADDEfficiency\\tests\\in3.v2"
#outDirectory <- "D:\\Studia\\doktorat\\DEA-diviz\\ImpreciseDEAValueADD\\ImpreciseDEAValueADDEfficiency\\tests\\out3.v2"
...
results <- handleException(
  function() return(
    calculateEfficiencyBoundsForAll(inputs, inputs$transformToUtilities))
  ,
  xmcdaMessages,
